...
public class Printsorted {
	...
	public static void main(String[] args) {
		 Employee emp1 = new Employee(1, "Allu", "A", 10000L);
		 Employee emp2 = new Employee(3, "Bharadwaj", "B", 20000L);
		 Employee emp3 = new Employee(2, "Sanju", "C", 30000L);
		 Employee emp4 = new Employee(4, "Apuu", "D", 30000L);
